...
+ (UILabel *)createLabelWithFrame:(CGRect)frame
                         FontSize:(int)fontSize
                             Text:(NSString *)text
{
    return [CSUIFactory createLabelWithFrame:frame FontSize:fontSize Text:text textColor:[UIColor blackColor]];
}
...
{
    return [CSUIFactory createLabelWithFrame:frame FontSize:fontSize Text:text textColor:[UIColor blackColor] NSTextAlignment:NSTextAlignmentLeft];
}
