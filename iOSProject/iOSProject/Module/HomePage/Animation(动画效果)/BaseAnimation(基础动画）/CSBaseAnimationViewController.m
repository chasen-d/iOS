//
//  CSBaseAnimationViewController.m
//  iOSProject
//
...
#import "CSBaseAnimationViewController.h"

@interface CSBaseAnimationViewController ()

@end

@implementation CSBaseAnimationViewController
...
- (void)viewDidLoad {
    ...
    //以 中心x 轴 翻转
    UIImageView *rorationImageViewX =[CSUIFactory createImageViewWithFrame:CGRectMake(20, 100, 70, 70) ImageName:@"apple"];
    ...
    //以 中心y 轴 翻转
    UIImageView *rorationImageViewY =[CSUIFactory createImageViewWithFrame:CGRectMake(150, 100, 70, 70) ImageName:@"apple"];
    ...
    //以 中心 z 轴 翻转
    UIImageView *rorationViewZ = [CSUIFactory createImageViewWithFrame:CGRectMake(280, 100, 70, 70) ImageName:@"apple"];
    ...
    /**------------------------移动动画-------------------------------------*/
    UIImageView *moveView = [CSUIFactory createImageViewWithFrame:CGRectMake(20, 240, 70, 70) ImageName:@"apple"];
    ...
    boundsAnim.autoreverses = YES; //回退动画（动画可逆，即循环）
